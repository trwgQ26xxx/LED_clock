...
#define EXT_TEMP_CONV_TRIGGER_CNT		3
#define EXT_TEMP_DATA_READ_CNT			31
...
#define INT_EXT_TEMP_CYCLING_TIME		5	//s
#define INT_EXT_TEMP_CYCLING_CNTR_MAX	(INT_EXT_TEMP_CYCLING_TIME * UPDATE_FREQUENCY)
